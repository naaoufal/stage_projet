...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">naoufelbenmensour@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+212 (61)467-58-55</li>	
				</ul>
			</div>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">YOU <span>DREAM</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="navbar justify-content-between">
						<ul class="nav navbar-nav menu__list">
							<li class=""><a href="" class="menu__link">Home</a></li>
							...
							<li class=""><a href="#contact" class="menu__link scroll">Contact Us</a></li>
							<!-- <li class="report"><a href="#report" id="repo" class="menu__link scroll">Report</a></li> -->
						</ul>
					</nav>
				</div>
			</nav>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">YOU DREAM</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our YOU DREAM</h3> 
...
<!-- //gallery -->
	...
	<div class="plans-section" id="report">
		<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Report a Service or Problem</h3>
			<form method="POST">
				...
				<input type="submit" id="sub1" name="sub1" class="btn btn-danger" value="Report">
			</form>
			<?php
			if(isset($_POST['sub1'])){
				...
				$email = $_POST['email1'];
				$desc = $_POST['desc1'];
				$sql1 = "INSERT INTO `report` (`full_name`, `email`, `date_report`, `desc_report`) VALUES ('$fullname', '$email', now(), '$desc')";
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+212 (61)467-58-55</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">naoufelbenmensour@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> New Safi Street, Safi, Morocco</p>
			...
			<iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=14%20Avenue%20Zerktouni,%20Safi+(youcode%20safi)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://www.maps.ie/map-my-route/">Draw Route on Google Maps</a></div>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 YOUDREAM . All Rights Reserved | Design by <a href="index.php">YOUDREAM</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
